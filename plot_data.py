...
ax2 = ax1.twinx()
ax1.plot(data_reservoir_filt["date_f"], data_reservoir_filt["storage_change"], "-b")
ax1.axhline(0, linestyle = "--", color = "r", alpha = .75)

# plot the bar chart
ax2.bar(data_precip_filt["date_f"], data_precip_filt["precip_24"], width = 0.9, alpha = .5)
...
ax1.legend(["Water Change"], loc = 2)
ax2.legend(["Precipitation"], loc = 3)
